# security-host-07: AtsSecurity, CAM and DENM profiles (sending side)

Campaign: `ports/esp_idf/tests/etsi_security_facilities.cfg` (7 cases), same
SUT, pool and adapter as `security-host-06` (re-run of security-host-04 with the verifying SUT) (`adapter-build.json` is the same
