# security-host-04: AtsSecurity, CAM and DENM profiles (sending side)

Campaign: `ports/esp_idf/tests/etsi_security_facilities.cfg` (7 cases), same
SUT, pool and adapter as `security-host-03` (re-run of security-host-02 with the 2026-09-14 sources) (`adapter-build.json` is the same
