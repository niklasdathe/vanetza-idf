# security-host-01: AtsSecurity, GN-MGMT profile (sending side)

Campaign: `ports/esp_idf/tests/etsi_security_gn.cfg` (8 cases), host SUT
...
| Quantity | Value | Unit |
| --- | --- | --- |
| `v_curTime` | 716387204309000 | µs |
| range checked | 716387204308700 .. 716387204309300 | (µs magnitude) |
| `validityPeriod.start_` | 716384398 | s |
| `generationTime` | 716387209308103 | µs (= 716387209 s) |
| `duration` | 24 | hours |
...
holds for the observed values: 716384398 s <= 716387209 s and the difference
(2811 s) is below 24 h. The current upstream head of the Security ATS
